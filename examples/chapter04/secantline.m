...
%%
% Instead of constructing the tangent line by evaluating the derivative, we
% can construct a linear model function by drawing the line between the two
% points $\bigl(x_1,f(x_1)\bigr)$ and $\bigl(x_2,f(x_2)\bigr)$. This is
% called a _secant line_.
slope2 = (f2-f1) / (x2-x1);
