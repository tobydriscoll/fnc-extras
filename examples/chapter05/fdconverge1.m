...
f = @(x) sin( exp(x+1) );
FD1 = [ (f(0.1)-f(0))/0.1; (f(0.05)-f(0))/0.05; (f(0.025)-f(0))/0.025 ]

%%
% It's not easy to see that the process is converging. However, the errors
% are cut approximately by a factor of 2 when $h$ is divided by 2.
