...
n = (5:5:60)';   err = 0*n;
x = linspace(0,1,1001)';         % points for measuring error
for k = 1:length(n) 
...
% $K>1$. This vanishes faster than $O(n^{-p})$ for any order of accuracy
% $p$. However, around $n=30$ the error starts to _grow_ exponentially. 
