...
# ╔═╡ aede3ec5-f77b-490c-8f06-57ae7a94944b
using PlutoUI

# ╔═╡ 84e57fcc-78ea-4051-bcb0-c65f661731c9
using FNCFunctions

# ╔═╡ ca648bec-7794-11f0-01bb-87e00b5d7bfb
md"""
# Section 1.3
"""

# ╔═╡ 7381fcd6-e913-4837-ae0b-cf77620d85ba
md"""
Here we show how to use {numref}`Function {number} <function-horner>` to evaluate a polynomial. It's not a part of core Julia; rather, it's provided by a package that has all the functions defined by this book. We load that package in a Julia session via the `using` command:
"""

# ╔═╡ 7260532d-fc91-4180-87cf-dd460cf020a1
details("Tip",
md"""
...
# ╔═╡ 8afe188d-d18c-490f-9e30-4c452b182eb3
md"""
It can be useful to define a shorthand for accessing the functions in an imported package. (This particular one is actually defined for you by default.)
"""

# ╔═╡ 2e8f7600-92ea-4b42-8e58-2f3819afad2d
details(
	"Tip",
	md"""
...
# ╔═╡ f75361cc-5b00-4a29-8de7-c41d29770c3a
md"""
Now let us define a vector of the coefficients of $p(x)=(x-1)^3=x^3-3x^2+3x-1$, in ascending degree order.
"""

# ╔═╡ f80cc370-0d1b-4ab2-a39b-64e26e51767b
c = [-1, 3, -3, 1]

# ╔═╡ 149f4fed-9777-4b32-b627-aaf4c8dc0f6c
md"""
In order to avoid clashes between similarly named functions, Julia has sandboxed all the book functions into a *namespace* called `FNC`. We must use this namespace whenever we invoke one of the functions.
"""

# ╔═╡ cfc95ff5-4ac2-4fd9-8d92-08107c1854b2
details(
	"Tip",
	md"""
...
# ╔═╡ 8267e342-79ab-4924-96be-876cf7034dd8
FNC.horner(c, 1.6)

# ╔═╡ 1a0faf6b-0dda-4a4a-9b16-8c8ace843fe8
md"""
...
manifest_format = "2.0"
project_hash = "abe860509e9b1aa72b1fc87b6e0e06e82b55331d"
...
[[deps.FNCFunctions]]
deps = ["LinearAlgebra", "OrdinaryDiffEq", "Polynomials", "SparseArrays"]
git-tree-sha1 = "45671899c05f559bf0f39e4b860a06e3d36f53ac"
...
git-tree-sha1 = "38e21d192e3549a402191ad7e91d07afdf801674"
